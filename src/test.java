...
public class test extends JFrame {
	...
	private static String[] word_array= {"bright","deep","accept","abundant","victory","bless","bold","hope","giant","guest","love","up","full"};
	private static String[] syn_array= {"dull","shallow","refuse","scarce","defeat","curse","timid","despair","dwarf","host","hate","down", "empty"};
